...
5. 返冋诊室。
6. 清理诊室，并为接待下一位病例做好准备。向动物主人提供书面说明以增加客户对医嘱的依从性。如果工作的动物诊所没有这样的表格，可以与办公室主任商讨制定一份客户指导用药说明。如果有这类表格，则要坚持使用。

## 谨记

向动物主人提供书面说明以增加客户对医嘱的依从性。如果工作的动物诊所没有这样的表格，可以与办公室主任商讨制定一份客户指导用药说明。如果有这类表格，则要坚持使用。
