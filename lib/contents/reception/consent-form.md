...
一份完整的表格将被保存于病历档案内。和其他病历单据一样，它必须是完整且准确的。同意书可以根据动物主人的不同要求来定制，所以一家动物诊所往往会使用多种同意书，如手术同意书、寄养同意书利安乐死同意书。有些动物诊所使用一种通用表格，再根据目的及流程来分类。 同遵守任何规章或流程一样，也应遵循动物诊所的具体工作要求。
